            ...
            <div class="col-md-12">
                <section class="kt-entry-content clearfix">
                    <?php if (has_post_thumbnail()): ?>
                        <figure>
                            <?php
                            the_post_thumbnail('greek-restaurant-page-image-col-md-12',
                                array
                ...
                <?php wp_link_pages(array('before' => '<div class="page-link"><span>' . __('Pages:', 'greek-restaurant') . '</span>', 'after' => '</div>')); ?>
...
<?php endwhile;
    ...
    <div class="kt-not-found">
        ...
        <?php _e('Well, it seems that nothing is here..', 'greek-restaurant'); ?>
    </div>
<?php endif; ?>